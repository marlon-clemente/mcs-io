...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close ref={ref} className="" toast-close="" {...props}>
    <LucideXCircle className="text-gray-800" />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Title ref={ref} className="" {...props} />
));
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description ref={ref} className="" {...props} />
));
